...
def get_deployment_best_practices(
    platform: str,
    use_case: str
) -> Dict[str, Any]:
    """
...
def get_framework_specific_best_practices(
    framework: str,
    use_case: str
) -> Dict[str, Any]:
    """
...
def register_module(mcp: FastMCP) -> None:
    ...
    mcp.add_tool(
        ...
        function=get_deployment_best_practices
    )
